...
public class ConcertTicket extends Ticket {
  ...
  public ConcertTicket(
      Ticket ticket, String concertHall, int eventCode, boolean isPromo, String sector) {
    super(ticket);
    this.concertHall =
        validateStringLimits(concertHall, "Concert Hall", new char[][] {{'A', 'Z'}, {'a', 'z'}});
  ...
  public void setSector(String sector) {
    this.sector =
        Sector.valueOf(
            validateStringLimits(sector, "Sector", new char[][] {{'A', 'C'}, {'a', 'c'}}));
  }
  ...
  public boolean equals(Object o) {
    ...
    return isPromo == that.isPromo
        && Objects.equals(concertHall, that.concertHall)
  ...
  public void share(String email, String phoneNumber) {
    System.out.println(
        "ConcertTicket was send to the next email - "
            + email
            + ", and phone - "
            + phoneNumber
            + "\n");
